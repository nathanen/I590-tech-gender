...
\cite{Benson:1987wl};  \cite{Wajcman:2000vq}; \cite{Bray:1997wl}
...
\subsection{Supplemental Readings}
\cite{Rossiter:1982vn}, \cite{Tichi:1987wb}
...
\subsection{Supplemental Readings}
\cite{Davies:1982vb}; \cite{Rakow:1992vx}; \cite{Pursell:1993td}
...
\cite{Ensmenger:2012vq}; \cite{Milkman:1987tl}; \cite{Shetterly:2016vl}
